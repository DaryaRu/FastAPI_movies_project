...
class TestPersonCache:
    @pytest.mark.parametrize(
        'path',
        [
            lambda pid: f"persons/{pid}/",
            lambda _: "persons/search?query=Tom",
            lambda _: "persons/",
        ],
    )   
...
class TestPersonList:
    ...
    async def test_person_list_pagination_different_pages(
        ...
        url1 = "persons/?page_number=1&page_size=5"
        url2 = "persons/?page_number=2&page_size=5"
    ...
    async def test_person_list_page_size(
        ...
        url = "persons/?page_size=5&page_number=1"
